...
The form for Figure \@ref(fig:base1) is linear.
...
```
```{r, label = "base2", fig.width = 12, fig.height = 4, fig.cap = "Base R scatterplot of `sales` versus `TV`, `radio`, and `newspaper`"}
par(mfrow = c(1, 3))
plot(sales ~ TV, data = AD, col = "red", pch = 19)
mod1 <- lm(sales ~ TV, data = AD)
abline(mod1, col = "blue")
...
Change the caption in Figure \@ref(fig:base2).
